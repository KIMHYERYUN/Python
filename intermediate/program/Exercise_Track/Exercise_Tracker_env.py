...
COMB_API_ID = os.environ.get("COMBAPIID")
COMB_API_KEY = os.environ.get("COMBAPIKEY")
...
#"https://dashboard.sheety.co/projects/629cafd9b4fa05309e09c197/sheets/workouts"
#export ADD_ROW_ENDPOINT=https://api.sheety.co/06c6a40627b3852f5d250d9baf3ebc19/workoutsTrecking/workouts
add_row_endpoint = os.environ.get("ADD_ROW_ENDPOINT")
...
# TODO 4. 환경변수 선언 - 적용 : USERNAME, PASSWORD, EXCEL GOOGLE SHEET API